 ...
 * @returns {Promise<AxiosResponse<Customer>>} - A Promise that resolves to the AxiosResponse containing the created customer.
 * @throws {Error} - Throws an error if the creation process fails.
 */
export const createCustomer = async (customer: CreateCustomer): Promise<AxiosResponse<Customer>> => {
    try {
 ...
 * @returns {Promise<AxiosResponse<Customer>>} - A Promise that resolves to the AxiosResponse containing the updated customer.
 * @throws {Error} - Throws an error if the update process fails.
 */
export const updateCustomer = async (customer: Customer): Promise<AxiosResponse<Customer>> => {
    try {
